...
class StudentManageSystem {
  ...
  parseCommand(input) {
    switch (input) {
      ...
      default:
        return RETURN_MSG.ERROR_COMMAND + RETURN_MSG.COMMAND;
    }
  }
  ...
  queryScores(studentNumbersStr) {
    ...
    this.consoleState = STATUS.COMMAND;
    return scoresString + RETURN_MSG.COMMAND;
  }
  ...
  addStudent(studentStr) {
    ...
    if (student) {
      ...
      return RETURN_MSG.ERROR_STUDENT_STR + RETURN_MSG.COMMAND;
    }
  }
