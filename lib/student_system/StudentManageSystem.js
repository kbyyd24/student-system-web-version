...
class StudentManageSystem {
  ...
  parseCommand(input) {
    switch (input) {
      case COMMAND.INPUT_STUDENT:
        this.consoleState = STATUS.ADD_STUDENT;
        return RETURN_MSG.EMPTY;
      case COMMAND.INPUT_STUDENT_NUMBER:
        this.consoleState = STATUS.QUERY_SCORE;
        return RETURN_MSG.EMPTY;
      case COMMAND.CLOSE:
        this.consoleState = STATUS.CLOSED;
        return RETURN_MSG.EMPTY;
      default:
        return RETURN_MSG.ERROR_COMMAND;
    }
  }
  ...
  addStudent(studentStr) {
    ...
    if (student) {
      ...
      return RETURN_MSG.ERROR_STUDENT_STR;
    }
  }
...
全班总成绩中位数:${clazz.median}\n`;
  ...
  static printWELCOME() {
    console.log(RETURN_MSG.WELCOME);
  }

  static printCommand(msg) {
    if (msg) {
      console.log(msg + RETURN_MSG.COMMAND);
    } else {
      console.log(RETURN_MSG.COMMAND);
    }
  }
  ...
  returnMsg(msg) {
    switch (this.consoleState) {
      case STATUS.COMMAND:
        return msg ? msg + RETURN_MSG.COMMAND : RETURN_MSG.COMMAND;
      case STATUS.ADD_STUDENT:
        return msg ? msg + RETURN_MSG.ADD_STUDENT : RETURN_MSG.ADD_STUDENT;
      case STATUS.QUERY_SCORE:
        return RETURN_MSG.QUERY_SCORE;
      case STATUS.CLOSED:
        return RETURN_MSG.GOODBYE;
    }
  }
}
